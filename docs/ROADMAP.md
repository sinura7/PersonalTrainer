...
> Records. `#217`–`#221` are on `trunk`. `#220` shipped live 36 as
> `debug-live-2026-09-10-8`. Open `#222` is the golden rounding
> allowance (HANDOFF + ROADMAP). This packet inherits 36 and does not
