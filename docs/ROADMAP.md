...
> copy that fails is now recorded there, where before it reached only
> the developer log, which needs a computer to read. Rides along with
> the next drop; nothing to check on the phone.
>
