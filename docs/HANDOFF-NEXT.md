...
`#191` briefly removed `#192`). `#204`/`#205`/`#206`/`#207` reused
`claude/android-verify-my59sw` — do **not** delete that head. `#204`,
`#205`, `#206` and `#207` are on `trunk`. `#201`/`#203`'s vehicle
...
`DESIGN_AUDIT.md`, or `ExactAlarmCapabilityInstrumentedTest` edit from
`trunk`. `#207` closed the exact-alarm emulator race. Do not take the
remaining hosted-emulator failures as this packet. `#196`'s vehicle
