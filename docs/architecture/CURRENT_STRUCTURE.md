...
audit packets X1 and X3, in W2a, in T3, in N1, in R4, and again in W2d-3a; the prose was first written on 11 September). Read this before
...
|---|---|---|---|
| `app/src/main` | 572 | 96,094 | — |
| `app/src/test` | 502 | 90,305 | 3,440 |
...
|---|---|---|---|
| `ui` | 177 | 47,253 | 18 screens, 21 ViewModels on an abstract `AppViewModel`, `ui/components`, `ui/theme`, `ui/navigation`, `ui/saveposture` |
...
- **`ActiveWorkoutViewModel` is 2,058 lines** with 24 `MutableStateFlow`
  ...
  `FloorWorkClocks`), and still holds rule decisions that belong in
