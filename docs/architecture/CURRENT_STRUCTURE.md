...
|---|---|---|---|
| `app/src/main` | 571 | 95,953 | — |
| `app/src/test` | 500 | 89,332 | 3,412 |
...
|---|---|---|---|
| `ui` | 176 | 47,112 | 18 screens, 21 ViewModels on an abstract `AppViewModel`, `ui/components`, `ui/theme`, `ui/navigation`, `ui/saveposture` |
