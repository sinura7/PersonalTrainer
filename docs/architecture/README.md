...
| [ADR-032](ADR-032-jvm-evidence-lanes.md) | JVM renders and JVM migration tests are the evidence lanes | Amends ADR-026 §8 (emulator goldens retired) and ADR-010 §7 (JVM migration test gates) |
