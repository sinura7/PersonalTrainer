...
| RT-2 (B6) | Once you have said no to notifications, the "Rest alerts" box comes back every time you open a workout or the rest page, and after two refusals its Continue does nothing. | rest-alarm packet: fixed 26 September (#433): answered once on the phone, Continue or Not now; the compact row stays the way back |
