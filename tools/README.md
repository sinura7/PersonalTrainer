...
is 1024×1024 so the panel is not upscaling 768. Heat stays 768. Body
muscle-row stills are ten 256×256 `muscle_*` WebPs, rendered from the
unlit figure by `tools/render-muscle-stills.py`.
