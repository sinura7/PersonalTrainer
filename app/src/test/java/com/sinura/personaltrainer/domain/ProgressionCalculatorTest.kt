...
class ProgressionCalculatorTest {
    ...
    fun extraRepsStillIncrease() {
        val suggested = ProgressionCalculator.suggestWeightKg(100.0, 8, 5, kg)
        assertEquals(102.5, suggested, 0.001)
    }

    @Test
    fun oneOrTwoRepsShortHoldsWeight() {
        assertEquals(80.0, ProgressionCalculator.suggestWeightKg(80.0, 4, 5, kg), 0.001)
        assertEquals(80.0, ProgressionCalculator.suggestWeightKg(80.0, 3, 5, kg), 0.001)
    ...
    fun threeOrMoreRepsShortDropsTwoPointFiveKg() {
        assertEquals(77.5, ProgressionCalculator.suggestWeightKg(80.0, 2, 5, kg), 0.001)
        assertEquals(ProgressionAction.DECREASE, ProgressionCalculator.action(2, 5))
    }

    @Test
    fun suggestionNeverGoesBelowZero() {
        assertEquals(0.0, ProgressionCalculator.suggestWeightKg(2.0, 0, 5, kg), 0.001)
    }
    ...
    fun aPoundUserStepsInPoundsNotConvertedKilograms() {
        ...
        val suggested = ProgressionCalculator.suggestWeightKg(100.0, 5, 5, step)
    ...
    fun aLiftWithNoStepHoldsItsWeightAndStillReadsAsProgress() {
        ...
        // that into "add a rep".
        val suggested = ProgressionCalculator.suggestWeightKg(0.0, 12, 12, stepKg = null)
        ...
        assertEquals(0.0, ProgressionCalculator.suggestWeightKg(0.0, 5, 12, stepKg = null), 0.001)
    }
