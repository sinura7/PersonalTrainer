...
object BackupJson {
    ...
    fun encode(document: BackupDocument): String {
        val sorted = document.copy(
            ...
            measurableGoals = document.measurableGoals.sortedBy { it.id },
        )
    ...
    private fun buildDocument(root: JsonObject, version: Int, app: String?): BackupDocument {
        return BackupDocument(
            ...
            measurableGoals = gsonPretty.fromJsonList(root, "measurableGoals", Array<BackupMeasurableGoal>::class.java),
        ).normalized()
    }
