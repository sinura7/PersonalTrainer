...
object DefaultExercises {
    ...
    private val CATALOG: List<SeedExercise> = listOf(
        ...
        // --- Batch 5 (v6): Freak Athlete Hyper Pro, 28 rows.
        //
        // Official laundry list from freakathlete.ca/pages/exercise-list (28 movements).
        // Each is its own catalog row with EquipmentType.HYPER_PRO so Library can chip-filter
        // the bench, the generator can keep gym barbells when both kits exist, and a Hyper-Pro-
        // only week still has a full posterior-chain vocabulary. Names stay prefixed so they
        // never collide with a gym sibling's nameKey. Appended: frozen-id tests read batch 1
        // as a prefix.
        seed(
            id = "ex-hyper-pro-45-degree-back-extension",
            name = "Hyper Pro 45-Degree Back Extension",
            muscleGroup = "Back",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "back-extension",
            primary = "back",
            secondaries = listOf("glutes" to 0.50, "hamstrings" to 0.50),
        ),
        seed(
            id = "ex-hyper-pro-90-degree-back-extension",
            name = "Hyper Pro 90-Degree Back Extension",
            muscleGroup = "Back",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "back-extension",
            primary = "back",
            secondaries = listOf("glutes" to 0.50, "hamstrings" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-bicep-curl",
            name = "Hyper Pro Bicep Curl",
            muscleGroup = "Biceps",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "curl",
        ...
        seed(
            id = "ex-hyper-pro-bulgarian-split-squat",
            name = "Hyper Pro Bulgarian Split Squat",
            muscleGroup = "Quads",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "lunge",
        ...
        seed(
            id = "ex-hyper-pro-calf-stretch",
            name = "Hyper Pro Calf Stretch",
            muscleGroup = "Calves",
            equipment = EquipmentType.HYPER_PRO,
        ...
        seed(
            id = "ex-hyper-pro-couch-stretch",
            name = "Hyper Pro Couch Stretch",
            muscleGroup = "Quads",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT,
        ...
        seed(
            id = "ex-hyper-pro-elephant-walk",
            name = "Hyper Pro Elephant Walk",
        ...
        seed(
            id = "ex-hyper-pro-external-rotator",
            name = "Hyper Pro External Rotator",
        ...
        seed(
            id = "ex-hyper-pro-face-pull",
            name = "Hyper Pro Face Pull",
        ...
        seed(
            id = "ex-hyper-pro-ghd-sit-up",
            name = "Hyper Pro GHD Sit-Up",
            muscleGroup = "Core",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "sit-up",
            primary = "core",
            secondaries = listOf("quadriceps" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-glute-ham-raise",
            name = "Hyper Pro Glute Ham Raise",
            muscleGroup = "Glutes",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "glute-ham-raise",
            primary = "glutes",
            secondaries = listOf("hamstrings" to 0.50, "back" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-hamstring-curl",
            name = "Hyper Pro Hamstring Curl",
            muscleGroup = "Hamstrings",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.EXTERNAL,
            movementKey = "leg-curl",
            primary = "hamstrings",
            secondaries = emptyList(),
        ),
        seed(
            id = "ex-hyper-pro-hip-thrust",
            name = "Hyper Pro Hip Thrust",
            muscleGroup = "Glutes",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.EXTERNAL,
            movementKey = "hip-thrust",
            primary = "glutes",
            secondaries = listOf("hamstrings" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-incline-pigeon",
            name = "Hyper Pro Incline Pigeon",
            muscleGroup = "Glutes",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT,
            movementKey = "pigeon",
        ...
        seed(
            id = "ex-hyper-pro-kot-squat",
            name = "Hyper Pro KOT Squat",
            muscleGroup = "Quads",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "squat",
            primary = "quadriceps",
            secondaries = listOf("glutes" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-leg-extension",
            name = "Hyper Pro Leg Extension",
            muscleGroup = "Quads",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.EXTERNAL,
            movementKey = "leg-extension",
            primary = "quadriceps",
            secondaries = emptyList(),
        ),
        seed(
            id = "ex-hyper-pro-leg-raise",
            name = "Hyper Pro Leg Raise",
            muscleGroup = "Core",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT,
            movementKey = "leg-raise",
            primary = "core",
            secondaries = listOf("quadriceps" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-nordic-curl",
            name = "Hyper Pro Nordic Curl",
            muscleGroup = "Hamstrings",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "nordic-curl",
            primary = "hamstrings",
            secondaries = emptyList(),
        ),
        seed(
            id = "ex-hyper-pro-pullover",
            name = "Hyper Pro Pullover",
            muscleGroup = "Back",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "pullover",
            primary = "back",
            secondaries = listOf("chest" to 0.50),
        ),
        seed(
            id = "ex-hyper-pro-push-up",
            name = "Hyper Pro Push-Up",
            muscleGroup = "Chest",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT,
            movementKey = "push-up",
        ...
        seed(
            id = "ex-hyper-pro-ql-raise",
            name = "Hyper Pro QL Raise",
            muscleGroup = "Back",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT,
            movementKey = "ql-raise",
            primary = "back",
            secondaries = listOf("core" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-reverse-hyper",
            name = "Hyper Pro Reverse Hyper",
            muscleGroup = "Back",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "reverse-hyper",
            primary = "glutes",
            secondaries = listOf("back" to 0.50, "hamstrings" to 0.25),
        ),
        seed(
            id = "ex-hyper-pro-reverse-nordic",
            name = "Hyper Pro Reverse Nordic",
            muscleGroup = "Quads",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT,
            movementKey = "reverse-nordic",
            primary = "quadriceps",
            secondaries = emptyList(),
        ),
        seed(
            id = "ex-hyper-pro-russian-twist",
            name = "Hyper Pro Russian Twist",
            muscleGroup = "Core",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "twist",
        ...
        seed(
            id = "ex-hyper-pro-sit-up",
            name = "Hyper Pro Sit-Up",
            muscleGroup = "Core",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT,
            movementKey = "sit-up",
        ...
        seed(
            id = "ex-hyper-pro-standing-row",
            name = "Hyper Pro Standing Row",
            muscleGroup = "Back",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "row",
            primary = "back",
            secondaries = listOf("biceps" to 0.50),
        ),
        seed(
            id = "ex-hyper-pro-trap-3-raise",
            name = "Hyper Pro Trap 3 Raise",
            muscleGroup = "Back",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "shrug",
        ...
        seed(
            id = "ex-hyper-pro-woodchop",
            name = "Hyper Pro Woodchop",
            muscleGroup = "Core",
            equipment = EquipmentType.HYPER_PRO,
            loadType = LoadType.BODYWEIGHT_PLUS,
            movementKey = "twist",
