...
object AccessibilityMatrix {
    ...
    val pages: List<PagePass> = listOf(
        PagePass(
            ...
            voltAction = "Start today's planned session, or Start a workout",
        ...
        PagePass(
            ...
            title = "History",
            states = requiredStates,
            voltAction = "Start a workout from the empty list",
        ...
        PagePass(
            ...
            states = requiredStates,
            voltAction = "Save routine",
            talkBackNotes = "Back dismisses without writing when canceled.",
            automatedEvidence = true,
        ),
        PagePass(
            id = "summary",
        ...
        PagePass(
            ...
            talkBackNotes = "Destructive dialogs name the session.",
            automatedEvidence = true,
        ),
        PagePass(
            id = "exercise-detail",
            ...
            states = requiredStates,
            voltAction = "Log against this lift from history, not a fifth tab",
            talkBackNotes = "Identity stays before metrics at 360 dp / font 2.0.",
            automatedEvidence = true,
        ),
        PagePass(
            id = "goals",
        ...
        PagePass(
            ...
            states = requiredStates,
            voltAction = "History year / all-time chips",
