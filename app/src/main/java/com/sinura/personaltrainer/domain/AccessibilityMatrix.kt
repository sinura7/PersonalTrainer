...
object AccessibilityMatrix {
    ...
    val pages: List<PagePass> = listOf(
        PagePass(
            ...
            talkBackNotes = "Last session and days-since tiles merge into one name each. Settings is a tab. Home week strip picks the day. This week, Library, and Goals stay off this screen.",
