...
object CatalogMeta {
    ...
    private val ROWS: Map<String, Entry> = mapOf(
        ...
        meta("ex-hyper-pro-calf-stretch", 760, setOf("calf mobility", "calf stretch")),
        meta("ex-hyper-pro-couch-stretch", 765, setOf("hip flexor stretch", "couch", "couch stretch")),
        meta("ex-hyper-pro-elephant-walk", 770, setOf("elephant", "hamstring stretch")),
        meta("ex-hyper-pro-incline-pigeon", 775, setOf("pigeon", "hip stretch", "90/90", "90/90 hips", "90 90 hips")),
